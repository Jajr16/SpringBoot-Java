 ...
 */
public class NewInscripcionRequestSaes {
    ...
    // ==================== CONSTRUCTORES =====================
    public NewInscripcionRequestSaes() {}

    public NewInscripcionRequestSaes(String boleta, String ets, String periodo, String turno, String user) {
        this.boleta = boleta;
        this.ets = ets;
