...
import com.example.PruebaCRUD.Services.IngresoInstalacionServicio;
...
public class IngresoInstalacionControlador {

    @Autowired
    private IngresoInstalacionServicio ingresoInstalacionServicio;
    ...
    public ResponseEntity<?> registrarAsistencia(
        ...
        try {
            ...
            boolean inscrito = ingresoInstalacionServicio.verificarInscripcionCompleta(boleta, idETS);
            if (!inscrito) {
            ...
            List<IngresoInstalacionDTO> registro = ingresoInstalacionServicio
