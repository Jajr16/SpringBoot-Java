...
//import com.example.PruebaCRUD.Repositories.DocenteRepository;
...
//        return args -> {
//
//            PersonalAcademico docente = docenteRepository.findByRfc("D").orElse(null);
//
